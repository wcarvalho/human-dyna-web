...
def save_figure(fig, filename):
  directory = f"{configs.DIRECTORY}/jaxmaze_individual_rts"
...
def create_two_paths_diff_rt_df(df: dataframe.DataFrame):
    ...
    for user_id in user_ids:
        ...
        reuse0_log_first_rt = np.log(1000 * reuse0_first_rt)
        reuse0_log_max_rt = np.log(1000 * reuse0_max_rt)
        ...
        reuse1_log_first_rt = np.log(1000 * reuse1_first_rt)
        reuse1_log_max_rt = np.log(1000 * reuse1_max_rt)
        
        # Calculate differences
        diff_first_rt = reuse0_first_rt - reuse1_first_rt
        diff_max_rt = reuse0_max_rt - reuse1_max_rt
        diff_log_first_rt = reuse0_log_first_rt - reuse1_log_first_rt
        diff_log_max_rt = reuse0_log_max_rt - reuse1_log_max_rt
        ...
        row = {
            ...
            "reuse0_log_first_rt": reuse0_log_first_rt,
            "reuse0_log_max_rt": reuse0_log_max_rt,
            "reuse1_first_rt": reuse1_first_rt,
            "reuse1_max_rt": reuse1_max_rt,
            "reuse1_log_first_rt": reuse1_log_first_rt,
            "reuse1_log_max_rt": reuse1_log_max_rt,
            "diff_first_rt": diff_first_rt,
            "diff_max_rt": diff_max_rt,
            "diff_log_first_rt": diff_log_first_rt,
            "diff_log_max_rt": diff_log_max_rt,
        }
...
def plot_min_median_max_differences(result_df, metric="first_rt", left_title_fn=lambda s: s, right_title_fn=lambda s: s, figsize=(15, 12), num_users=None):
    """
...
if __name__ == "__main__":
    ...
    fig = plot_min_median_max_differences(paths_diff_df, 'first_rt',
    ...
    fig = plot_min_median_max_differences(juncture_df, 'first_rt', 

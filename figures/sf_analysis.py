...
def make_sf_plot(sf_df, seed=1):
  ...
  train_settings = dict(eval=False, seed=seed, manipulation=3, EVAL_TASK_SUPPORT='eval', task=26)
  train_df = sf_df.filter(**train_settings)
  eval_settings = dict(eval=True, seed=seed, manipulation=3, EVAL_TASK_SUPPORT='eval', task=40)

...
def render_craftax_pixels(state, block_pixel_size, do_night_noise=True):
  ...
  map_pixels = (
    map_pixels * (1 - textures["full_map_player_textures_alpha"][player_texture_index])

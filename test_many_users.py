                ...
                try:
                    ...
                    try:
                        ...
                        if await button.is_visible():
                            await button.click()
                            print(
                                f"Browser {context_number}: Clicked start button")
                    except:
                        pass
                    ...
                    try:
                        ...
                        if await button.is_visible():
                            await button.click()
                            print(
                                f"Browser {context_number}: Clicked next button")
                    ...
                    try:
                        ...
                        if await button.is_visible():
                            await button.click()
                            print(
                                f"Browser {context_number}: Clicked submit button")
                    ...
                    print(
                        f"Browser {context_number}: Error pressing key - {str(e)}")
...
async def main():
    ...
    parser.add_argument('-c', '--connections', type=int, default=30,
